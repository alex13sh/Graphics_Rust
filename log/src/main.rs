...
fn main() -> std::io::Result<()> {
    convert_log_file("values_14_09_2020__13_24_19_668.json")
}
...
fn convert_log_file(file_name: &str) -> std::io::Result<()> {
//     let file_name = "values_14_09_2020__13_24_19_668.json";
    let path = get_file_path(&(String::from("log/") + file_name));
    println!("Path: {:?}", path);
...
//     dbg!(&js);
    ...
    let path = get_file_path(&(String::from("new_log/") + file_name));
